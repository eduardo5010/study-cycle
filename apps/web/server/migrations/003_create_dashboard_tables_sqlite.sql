-- Migration: create dashboard tables for SQLite
-- Run with sqlite3 or drizzle-kit
...
CREATE TABLE IF NOT EXISTS user_stats (
  ...
  weekly_goal INTEGER DEFAULT 420, -- minutes per week
  monthly_goal INTEGER DEFAULT 1800, -- minutes per month
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  data TEXT DEFAULT '{}', -- JSON string for SQLite
