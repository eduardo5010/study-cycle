...
export default function ChatsPage() {
  ...
  const chatGroups: ChatGroup[] = [
    ...
    },
    {
      ...
      description: "Quantum physics and mechanics",
      memberCount: 8,
      isStudyGroup: true,
      avatar: "⚛️"
    },
    ...
    {
      id: "4",
      name: "General Study Chat",
      description: "Casual study discussions and motivation",
      memberCount: 25,
      isStudyGroup: false,
      avatar: "💬"
    }
  ...
  const mockMessages: Message[] = selectedGroup ? [
    {
      id: "1",
      senderId: "user1",
      senderName: "Alice Johnson",
      senderAvatar: "A",
      content: `Welcome to ${selectedGroup.name}! Let's discuss the latest topics.`,
    ...
    },
    {
      ...
      senderAvatar: "B",
      content: "I'm struggling with the last exercise. Can someone help?",
    ...
    },
    {
      ...
      senderAvatar: user?.name?.charAt(0) || "Y",
