...
export default function LeftSidebar() {
  ...
  const studyItems = visibleMenuItems.filter(item =>
    ['home', 'cycle-create', 'cycle-edit', 'flashcards', 'ai-flashcards', 'calendar'].includes(item.id)
  );
  ...
  return (
    <aside className="w-64 bg-card border-r border-border h-[calc(100vh-4rem)] sticky top-16 overflow-y-auto sidebar-scroll">
